...
@Service
public class TestCase5Service extends AbstractTestCaseService {

    private final Logger log = LoggerFactory.getLogger(TestCase5Service.class);
    ...
    public TestCaseEntity executeTestSteps(OAuth2AuthorizedClient authorizedClient) {
        ...
        final Entity entity = new Entity(
                dataset.getLocation(dmpScheme.getDmp().getLocation("")),
                "dataset:identifier", "https://hdl.handle.net/1234");
        dataset.getDataset_id().setIdentifier("https://hdl.handle.net/1234");
        ...
        final ResponseEntity<String> responseEntity2 = Functions.sendHTTPRequest(log,
                indmpHost + indmpUpdateIdentifier + Functions.getDMPParameters(dmpScheme.getDmp(), LocalDateTime.now()),
    ...
    public String validate(OAuth2AuthorizedClient authorizedClient, TestCaseEntity testCaseEntity) {
        ...
        return Functions.processSuccess(log, "Identifier was changed");
    }
