...
public class ModelConstants {
    ...
    // PID System
    public static final String REGEX_PID_SYSTEM = "^("
            + "ark|"
            + "arxiv|"
            + "bibcode|"
            + "doi|"
    ...
    // ISO 4212
    public static final String REGEX_ISO_4212 = "^("
            + "AED|"
            + "AFN|"
            + "ALL|"
            + "AMD|"
    ...
    public static final String REGEX_ISO_3166_1 = "^("
            + "AD|"
            + "AE|"
            + "AF|"
            + "AG|"
    ...
    // Language pattern: ISO 639-3
    public static final String REGEX_ISO_639_3 = "^("
            + "aar|"
            + "abk|"
            + "afr|"
            + "aka|"
